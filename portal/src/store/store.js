...
import {
  loginSaga,
  logoutSaga,
  createShopifyUserSaga,
  registerInvitedUserSaga,
  registerInvitedConsignorSaga
} from "./authorization/AuthSagas";
...
import {
  fetchAdminUsersSaga,
  inviteUserSaga
} from "./admin/users/AdminUsersSaga";
import {
  inviteConsignorSaga,
  fetchResellerConsignorsSaga
} from "./reseller/consignors/RConsignorsSaga";
import {
  fetchResellerItemsSaga,
  createResellerItemsSaga
} from "./reseller/items/RItemsSaga";
...
import rootResellerSingleItemSaga from "./reseller/single-item/RSingleItemSaga";
import rootResellerSingleConsignorSaga from "./reseller/single-consignor/RSingleConsignorSaga";
...
sagaMiddleware.run(rootResellerSingleItemSaga);
sagaMiddleware.run(rootResellerSingleConsignorSaga);
