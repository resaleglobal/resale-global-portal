...
import { submitRegisterInvitedUser } from "../../store/authorization/AuthActions";
...
class InviteUserPage extends Component {
  ...
  handleSubmit = (email, domain, token) => {
    this.setState({
      passwordError: false,
      emailError: false
    });
    ...
    if (pass) {
      this.props.submitRegisterInvitedUser({
        email,
        ...
        <div className="login-box">
          ...
          <div className="box-body">
            ...
            <Button
              ...
              color="primary"
              variant="outlined"
              onClick={() => this.handleSubmit(email, domain, token)}
              disabled={loading}
            >
              {loading ? (
...
const mapDispatchToProps = dispatch => {
  return {
    submitRegisterInvitedUser: param => dispatch(submitRegisterInvitedUser(param))
  };
};
